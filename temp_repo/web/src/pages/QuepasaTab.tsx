...
export const QuepasaTab: React.FC = () => {
  ...
  return (
      <div className="max-w-7xl mx-auto space-y-6">
        <div className="flex justify-between items-center">
          <div>
            <h1 className="text-3xl font-bold text-gray-900 dark:text-white">Quepasa → Chatwoot</h1>
            <p className="text-gray-600 dark:text-gray-400 mt-1">Gerencie integrações Quepasa-Chatwoot</p>
          </div>
          ...
          <div className="overflow-x-auto">
            <table className="w-full">
              <thead className="bg-cw-bg-light dark:bg-cw-surface-dark">
                <tr>
                  <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase">Telefone Quepasa</th>
                ...
                {mappings.length === 0 ? (
                  ...
                  mappings.map((mapping) => (
                    <tr key={mapping.id} className="hover:bg-cw-bg-light dark:hover:bg-cw-bg-dark/30 transition-colors">
                      ...
                      <td className="px-6 py-4 text-sm text-gray-600 dark:text-gray-300">{mapping.name || '-'}</td>
