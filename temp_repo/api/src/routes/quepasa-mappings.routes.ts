...
const quepasaMappingSchema = z.object({
  ...
  returnWebhookUrl: z.string().url().optional().or(z.literal('')),
  useTypebot: z.boolean().optional(),
  typebotFlowId: z.string().optional(),
  typebotHost: z.string().url().optional().or(z.literal('')),
  typebotApiKey: z.string().optional(),
  useNativeBot: z.boolean().optional(),
  ...
  officialWabaId: z.string().optional(),
  ...
  syncBotMessagesToChatwoot: z.boolean().optional(),
  ...
  try {
    ...
    const mappings = await prisma.quepasaMapping.findMany({
      ...
      select: {
        ...
        showAgentName: true,syncBotMessagesToChatwoot: true,
        useTypebot: true,
        typebotFlowId: true,
        typebotHost: true,
        typebotApiKey: true,
  ...
  try {
    ...
    const mapping = await prisma.quepasaMapping.create({
      data: {
        ...
        closingMessage: validated.closingMessage || null,
        returnWebhookUrl: validated.returnWebhookUrl || null,
        useTypebot: validated.useTypebot ?? false,
        typebotFlowId: validated.typebotFlowId || null,
        typebotHost: validated.typebotHost || null,
        typebotApiKey: validated.typebotApiKey || null,
        useNativeBot: validated.useNativeBot ?? false,
        ...
        officialWabaId: validated.officialWabaId || null,
        ...
        syncBotMessagesToChatwoot: validated.syncBotMessagesToChatwoot ?? true,
